    ...
    async (formData: any) => {
      try {
        ...
        if (err instanceof Yup.ValidationError) {
          ...
          if (paymentFormRef.current && newErrors) {
            paymentFormRef.current.setErrors(newErrors);
            paymentFormRef.current
              .getFieldRef(Object.keys(newErrors)[0])
              .focus();
          }
          ...
          >
            ...
            >
              <Flex width="100%" flexDirection="column">
                ...
                >
                  <Flex width={['100%', '48%']}>
                    <Input label="Nome" name="first_name" isRequired />
                  </Flex>

                  <Flex width={['100%', '48%']}>
                    <Input label="Sobrenome" name="last_name" isRequired />
                  </Flex>
                </Flex>
                ...
                >
                  ...
                  <Flex width={['100%', '56%']} alignItems="center">
                    <Select
                      isRequired
                      maxWidth="104px"
                      name="country_code"
                      ...
                      defaultValue="55"
                      fontSize="12px"
                      onChange={e => setDDI(e.currentTarget.value)}
                      mb="0px"
                    >
                ...
                <Flex width="100%">
                  ...
                  >
                    <Stack spacing={2} direction={['column', 'row']}>
                      {paymentSettings &&
                        paymentSettings.paymentMethods.map(item => (
                          <Radio colorScheme="green" value={item.type}>
                            <Text fontSize="12px">
